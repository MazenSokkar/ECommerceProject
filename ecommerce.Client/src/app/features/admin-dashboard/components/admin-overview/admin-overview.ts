  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Manage Users Card -->
        <a routerLink="../users" class="section-card p-6 block hover:-translate-y-1 hover:shadow-lg transition-all group">
            <div class="w-12 h-12 rounded-xl bg-teal-50 dark:bg-teal-900/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <p class="text-sm text-neutral-500 dark:text-slate-400 mt-1">View, edit, restrict, or delete user accounts and assign roles.</p>
        </a>

        <!-- Manage Banners Card -->
        <a routerLink="../banners" class="section-card p-6 block hover:-translate-y-1 hover:shadow-lg transition-all group">
            <div class="w-12 h-12 rounded-xl bg-amber-50 dark:bg-amber-900/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">

...
public static class DataSeeder
{
    public static async Task SeedAsync(AppDbContext context)
    {
        ...
        if (!await context.Products.AnyAsync())
        {
            ...
            {
                // Phones
                new() { Name = "iPhone 15 Pro", Description = "Latest Apple iPhone with A17 Pro chip", Price = 999.99m, Stock = 50, CategoryId = phones.Id, MerchantId = merchant.Id, IsActive = true },
                ...
                // Laptops
                new() { Name = "MacBook Pro M3", Description = "Apple MacBook Pro with M3 chip", Price = 1999.99m, Stock = 20, CategoryId = laptops.Id, MerchantId = merchant.Id, IsActive = true },
                ...
                // Fashion
                new() { Name = "Nike Air Max 270", Description = "Comfortable everyday sneakers", Price = 149.99m, Stock = 100, CategoryId = fashion.Id, MerchantId = merchant.Id, IsActive = true },
                ...
                // Home
                new() { Name = "Dyson V15 Vacuum", Description = "Cordless vacuum with laser detection", Price = 749.99m, Stock = 25, CategoryId = home.Id, MerchantId = merchant.Id, IsActive = true },
                ...
                // Books
                new() { Name = "Clean Code", Description = "A handbook of agile software craftsmanship", Price = 39.99m, Stock = 100, CategoryId = books.Id, MerchantId = merchant.Id, IsActive = true },

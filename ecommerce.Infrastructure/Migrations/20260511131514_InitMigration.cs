        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Merchants_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StateProvinces_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StateProvinces_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "c3261412-397e-415b-8ce3-49f01af7ca55", "Admin", "ADMIN" },
                    { 2, "d9bd616e-1f7a-41f0-8742-a69418ea78e8", "Merchant", "MERCHANT" },
                    { 3, "1a16f412-bc6e-4e9a-9ae7-0716ee104151", "Corperate", "CORPERATE" },
                    { 4, "1aef7a54-7061-4a9e-b076-6cc910b4cd83", "Receiver", "RECEIVER" },
                    { 5, "67693004-4603-49fb-b99d-3f47620d76cf", "Customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, true, "add65ac8-5085-4291-8f04-110b61ef9974", "mazensokar.priv@gmail.com", true, "Mazen", "Sokar", false, null, "MAZENSOKAR.PRIV@GMAIL.COM", "MAZENSOKAR.PRIV@GMAIL.COM", "AQAAAAIAAYagAAAAEFJJyAaEJ2RzvWsjB9KkqroM8VRtYS4WOCVwt9mI8c5hnqYQTVK6LXDGKdBLJpa/Hg==", null, false, "2F16D08F01794AA5A45DDA8180D05173", false, "mazensokar.priv@gmail.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StateProvinces_CreatedById",
                table: "StateProvinces",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_StateProvinces_UpdatedById",
                table: "StateProvinces",
                column: "UpdatedById");
        }
